...
export default function Sidebar() {
    ...
    return (
        <>
            ...
            <div className={`fixed top-0 left-0 h-full bg-gray-100  w-64 h-full bg-white border-r border-gray-300 ${open ? "translate-x-0" : "-translate-x-full"}  z-1`}>
                ...
                <ul className="p-4 text-xl gap-3 flex flex-col">
                    <li className="py-2 ">
                    ...
                    <li className="py-2">
                        <a href="/divisions" className="flex items-center gap-2 hover:bg-gray-900/10 hover:rounded-sm p-4 hover:scale-105 transition">
                        <i className="fas fa-list"></i> View Divisions
                        </a>
                    </li>
                    <li className="py-2">
                    ...
                    <li className="py-2">
                        <a href="/competitors" className="flex items-center gap-2 hover:bg-gray-900/10 hover:rounded-sm p-4 hover:scale-105 transition">
                        <i className="fas fa-list"></i> View Competitors
                        </a>
                    </li>
                    <li className="py-2">
                    ...
                    <li className="py-2">
                        <a href="/competitions" className="flex items-center gap-2 hover:bg-gray-900/10 hover:rounded-sm p-4 hover:scale-105 transition">
                        <i className="fas fa-list"></i> View Competitions
                        </a>
                    </li>
                    <li className="py-2">
                    ...
                    <li className="py-2">
                        <a href="/judges" className="flex items-center gap-2 hover:bg-gray-900/10 hover:rounded-sm p-4 hover:scale-105 transition">
                        <i className="fas fa-list"></i> View Judges
                        </a>
                    </li>
                    <li className="py-2">
                    ...
                    <li className="py-2">
                        <a href="/users" className="flex items-center gap-2 hover:bg-gray-900/10 hover:rounded-sm p-4 hover:scale-105 transition">
                        <i className="fas fa-list"></i> View Users
                        </a>
                    </li>
                </ul>
            </div>
